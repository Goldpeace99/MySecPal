...
def URLexist(website):
	headers = {
    'User-Agent': 'My User Agent 1.0',
    'From': 'http://mysecpal.ppmgsliven.com'
	}
...
if counter == 0:
	print("""
		No admin pannel/hidden link were found
	"""
	)
